    ...
    <div>
      ...
      <div className="flex justify-center items-center min-h-screen py-8 flex-col">
        ...
        <div className="my-3 px-16 text-center">
          <span className="text-lg text-center font-bold text-green-500 mr-2">
        ...
        <button className="flex justify-center items-center mx-4 btn-wide btn-circle py-9 bg-green-500 text-white" onClick={handleGetStarted}>
